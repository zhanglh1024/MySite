...
namespace MySite.Core
{
    public class FileUpLoad
    {
        ...
        public class ImageUpload
        {
            ...
            private string _AddText = "恩典书城";//设置水印内容
            ...
            {
                if (_InFileName.Trim() == "")
                    return DateTime.Now.ToTimestamp() + Ext;
                else

                    return _InFileName.Split('.').GetValue(0).ToString() + "_" + DateTime.Now.ToTimestamp() + "." + _InFileName.Split('.').GetValue(1).ToString();
            }
            ...
            public void Upload()
            {
                HttpPostedFile hpFile = _FormFile;
                ...
                try
                {
                    ...
                    if (_IsCreateImg)
                    {
                        ...
                        Image newImg = Img.GetThumbnailImage(_sWidth, _sHeight, null, System.IntPtr.Zero);
